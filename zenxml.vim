" VIM color file modified from Zenburn to mute tags when editing XML.
" This ensures the text appears more prominently.
" Modified by Scott Moonen.
" Original follows with modifications annotated by SCM.
" 
" Vim color file
...
hi Function        guifg=#efef8f                              ctermfg=131
hi Identifier      guifg=#776e5e                              ctermfg=223 cterm=none
...
hi Statement       guifg=#716755 gui=none                     ctermfg=187 cterm=none
...
hi Type            guifg=#dfdfbf gui=bold                     ctermfg=94
